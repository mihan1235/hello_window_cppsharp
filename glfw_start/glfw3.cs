...
namespace glfw3
{
    ...
    /// <summary>The function signature for window maximize/restore callbacks.</summary>
    ...
    /// </param>
    /// <remarks>
    /// <para>This is the function signature for window maximize/restore callback</para>
    /// <para>functions.</para>
    ...
    public unsafe partial class GLFWgamepadstate : IDisposable
    {
        ...
        protected int __PointerAdjustment;
        internal static readonly global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::glfw3.GLFWgamepadstate> NativeToManagedMap = new global::System.Collections.Concurrent.ConcurrentDictionary<IntPtr, global::glfw3.GLFWgamepadstate>();
        protected void*[] __OriginalVTables;

        protected bool __ownsNativeInstance;

        internal static global::glfw3.GLFWgamepadstate __CreateInstance(global::System.IntPtr native, bool skipVTables = false)
        {
            return new global::glfw3.GLFWgamepadstate(native.ToPointer(), skipVTables);
        }

        internal static global::glfw3.GLFWgamepadstate __CreateInstance(global::glfw3.GLFWgamepadstate.__Internal native, bool skipVTables = false)
        {
            return new global::glfw3.GLFWgamepadstate(native, skipVTables);
        }

        private static void* __CopyValue(global::glfw3.GLFWgamepadstate.__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(global::glfw3.GLFWgamepadstate.__Internal));
            *(global::glfw3.GLFWgamepadstate.__Internal*) ret = native;
            return ret.ToPointer();
        }

        private GLFWgamepadstate(global::glfw3.GLFWgamepadstate.__Internal native, bool skipVTables = false)
            : this(__CopyValue(native), skipVTables)
        {
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
        ...
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::glfw3.GLFWgamepadstate.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
        }

        public GLFWgamepadstate(global::glfw3.GLFWgamepadstate _0)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::glfw3.GLFWgamepadstate.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            *((global::glfw3.GLFWgamepadstate.__Internal*) __Instance) = *((global::glfw3.GLFWgamepadstate.__Internal*) _0.__Instance);
        }
        ...
        public virtual void Dispose(bool disposing)
        {
            if (__Instance == IntPtr.Zero)
                return;
            global::glfw3.GLFWgamepadstate __dummy;
            NativeToManagedMap.TryRemove(__Instance, out __dummy);
            if (__ownsNativeInstance)
                Marshal.FreeHGlobal(__Instance);
            __Instance = IntPtr.Zero;
        ...
        public byte[] Buttons
        {
            ...
            {
                byte[] __value = null;
                if (((global::glfw3.GLFWgamepadstate.__Internal*) __Instance)->buttons != null)
                {
                    __value = new byte[15];
                    for (int i = 0; i < 15; i++)
                        __value[i] = ((global::glfw3.GLFWgamepadstate.__Internal*) __Instance)->buttons[i];
                }
                return __value;
            }
            ...
            set
            {
                ...
                {
                    for (int i = 0; i < 15; i++)
                        ((global::glfw3.GLFWgamepadstate.__Internal*) __Instance)->buttons[i] = value[i];
                }
            }
        }
        ...
        public float[] Axes
        {
            ...
            {
                float[] __value = null;
                if (((global::glfw3.GLFWgamepadstate.__Internal*) __Instance)->axes != null)
                {
                    __value = new float[6];
                    for (int i = 0; i < 6; i++)
                        __value[i] = ((global::glfw3.GLFWgamepadstate.__Internal*) __Instance)->axes[i];
                }
                return __value;
            }
            ...
            set
            {
                ...
                {
                    for (int i = 0; i < 6; i++)
                        ((global::glfw3.GLFWgamepadstate.__Internal*) __Instance)->axes[i] = value[i];
                }
            }
        }
    }
    ...
    public unsafe partial class glfw3
    {
        ...
        {
            [SuppressUnmanagedCodeSecurity]
            [DllImport("glfw3dll", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                EntryPoint="glfwInit")]
            ...
            [SuppressUnmanagedCodeSecurity]
            [DllImport("glfw3dll", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                EntryPoint="glfwInitHintString")]
            internal static extern void GlfwInitHintString(int hint, [MarshalAs(UnmanagedType.LPStr)] string value);
        ...
        /// <para>bundle, if present.  This can be disabled with the</para>
        /// <para>GLFW_COCOA_CHDIR_RESOURCES init hint.</para>
        ...
        /// <param name="hint">The [init hint](</param>
        /// <param name="value">The new value of the init hint.</param>
        /// <remarks>
        /// <para>This function sets hints for the next initialization of GLFW.  Only integer</para>
        /// <para>type hints can be set with this function.</para>
        ...
        /// <para>will only affect their specific platform.  Other platforms will simply</para>
        /// <para>ignore them.  Setting these hints requires no platform specific headers or</para>
        /// <para>functions.</para>
        /// <para>Possible errors include</para>
        ...
        /// <param name="value">The new value of the init hint.</param>
        /// <remarks>
        /// <para>This function sets hints for the next initialization of GLFW.  Only string</para>
        /// <para>type hints can be set with this function.</para>
        /// <para>The values you set hints to are never reset by GLFW, but they only take</para>
        /// <para>effect during initialization.  Once GLFW has been initialized, any values</para>
        /// <para>you set will be ignored until the library is terminated and initialized</para>
        ...
        /// <para>init_hints</para>
        /// <para>glfwInit</para>
        /// <para>glfwInitHint</para>
        /// <para>Added in version 3.3.</para>
        /// </remarks>
        public static void GlfwInitHintString(int hint, string value)
        {
            __Internal.GlfwInitHintString(hint, value);
        }
        ...
        /// <returns>
        /// <para>The last error code for the calling thread, or</para>
        /// <para>(zero).</para>
        /// <para>None.</para>
        ...
        /// </returns>
        /// <remarks>
        /// <para>This function returns and clears the [error code](</para>
        ...
        /// <para>The error code is set before the callback is called.  Calling</para>
        /// <para>glfwGetError from the error callback will return the same value as the error</para>
        ...
        /// <para>For gamma correct rendering with OpenGL or OpenGL ES, see the</para>
        /// <para>GLFW_SRGB_CAPABLE hint.</para>
        /// <para>Possible errors include</para>
        /// <para>GLFW_INVALID_VALUE and</para>
        /// <para>Gamma handling is currently unavailable, this function will</para>
        /// <para>always emit</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>Added in version 3.0.</para>
        /// </remarks>
        ...
        /// <para>Gamma handling is currently unavailable, this function will</para>
        /// <para>always return `NULL` and emit</para>
        ...
        /// </returns>
        /// <remarks>
        /// <para>Screensaver inhibition is currently unimplemented.</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>The wl_shell protocol does not support window</para>
        /// <para>icons, the window will inherit the one defined in the application's</para>
        /// <para>desktop file, so this function emits</para>
        ...
        /// <para>The window frame is currently unimplemented, as if</para>
        /// <para>[GLFW_DECORATED](</para>
        /// <para>A compositor can still emit close, resize or maximize events, using for</para>
        /// <para>example a keybind mechanism.</para>
        /// <para>The name and class of the `WM_CLASS` window property will by</para>
        /// <para>default be set to the window title passed to this function.  Set the</para>
        /// <para>GLFW_X11_WM_CLASS_NAME and</para>
        /// <para>initialization to override this.</para>
        ...
        /// <para>[GLFW_COCOA_FRAME_AUTOSAVE](</para>
        /// <para>specified window size may be overriden by a previously saved size and</para>
        /// <para>position.</para>
        ...
        /// <para>disabled entirely with the</para>
        ...
        /// <para>hint is `GLFW_TRUE` and the `NSHighResolutionCapable` key is enabled in the</para>
        ...
        /// <para>[Bundle Programming Guide](https://developer.apple.com/library/mac/documentation/CoreFoundation/Conceptual/CFBundles/)</para>
        /// <para>in the Mac Developer Library.</para>
        /// <para>The wl_shell protocol does not support icons, the window</para>
        /// <para>will inherit the one defined in the application's desktop file, so this</para>
        /// <para>function emits</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>Added in version 3.2.</para>
        /// </remarks>
        ...
        /// <para>The window frame is currently unimplemented, as if</para>
        /// <para>[GLFW_DECORATED](</para>
        /// <para>so the returned values will always be zero.</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>Added in version 3.1.</para>
        /// </remarks>
        ...
        /// <para>function will always emit</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>Added in version 2.1.</para>
        /// <para>Added window handle parameter.</para>
        /// </remarks>
        ...
        /// <para>Added in version 3.3.</para>
        /// </remarks>
        public static void GlfwRequestWindowAttention(global::glfw3.GLFWwindow window)
        {
            var __arg0 = ReferenceEquals(window, null) ? global::System.IntPtr.Zero : window.__Instance;
        ...
        /// <para>The supported attributes are [GLFW_DECORATED](</para>
        ...
        /// <para>Added in version 3.3.</para>
        /// </remarks>
        public static void GlfwSetWindowAttrib(global::glfw3.GLFWwindow window, int attrib, int value)
        {
            var __arg0 = ReferenceEquals(window, null) ? global::System.IntPtr.Zero : window.__Instance;
        ...
        /// <para>this callback will never be called.</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>Added in version 3.0.</para>
        /// </remarks>
        ...
        /// <para>Added in version 3.3.</para>
        /// </remarks>
        public static global::glfw3.GLFWwindowmaximizefun GlfwSetWindowMaximizeCallback(global::glfw3.GLFWwindow window, global::glfw3.GLFWwindowmaximizefun cbfun)
        {
            var __arg0 = ReferenceEquals(window, null) ? global::System.IntPtr.Zero : window.__Instance;
            var __arg1 = cbfun == null ? global::System.IntPtr.Zero : Marshal.GetFunctionPointerForDelegate(cbfun);
            var __ret = __Internal.GlfwSetWindowMaximizeCallback(__arg0, __arg1);
            var __ptr0 = __ret;
            return __ptr0 == IntPtr.Zero? null : (global::glfw3.GLFWwindowmaximizefun)Marshal.GetDelegateForFunctionPointer(__ptr0, typeof(global::glfw3.GLFWwindowmaximizefun));
        }
        ...
        /// <para>The mode must be one of</para>
        /// <para>Possible errors include</para>
        /// <para>GLFW_INVALID_ENUM.</para>
        /// <para>This function must only be called from the main thread.</para>
        /// <para>Added in version 3.0.</para>
        ...
        /// <para>__Do not use this function__ for [text input](</para>
        ...
        /// <param name="jid">The [joystick](</param>
        /// <returns>
        ...
        /// <para>For backward compatibility with earlier versions that did not have</para>
        /// <para>glfwGetJoystickHats, the button array also includes all hats, each</para>
        ...
        /// <para>_left_.  To disable these extra buttons, set the</para>
        /// <para>GLFW_JOYSTICK_HAT_BUTTONS init hint before initialization.</para>
        /// <para>If the specified joystick is not present this function will return `NULL`</para>
        /// <para>but will not generate an error.  This can be used instead of first calling</para>
        ...
        /// <summary>Returns the SDL comaptible GUID of the specified joystick.</summary>
        /// <param name="jid">The [joystick](</param>
        /// <returns>
        ...
        /// <para>platforms, you need to call one of the [event processing](</para>
        /// <para>functions.  Joystick disconnection may also be detected and the callback</para>
        ...
        /// <para>connected, it has no gamepad mapping or an [error](</para>
        /// <para>occurred.</para>
        /// <para>Possible errors include</para>
        /// <para>GLFW_INVALID_ENUM.</para>
        /// </returns>
        /// <remarks>
        /// <para>This function retrives the state of the specified joystick remapped to</para>
        ...
        /// <para>Not all devices have all the buttons or axes provided by</para>
        /// <para>GLFWgamepadstate.  Unavailable buttons and axes will always report</para>
        /// <para>`GLFW_RELEASE` and 1.0 respectively.</para>
        /// <para>Added in version 3.3.</para>
        /// </remarks>
        public static int GlfwGetGamepadState(int jid, global::glfw3.GLFWgamepadstate state)
        {
        ...
        /// <para>Possible errors include</para>
        /// <para>GLFW_PLATFORM_ERROR.</para>
        /// <para>Clipboard is currently unimplemented.</para>
        ...
        /// <para>The availability of a Vulkan loader and even an ICD does not by itself</para>
        /// <para>guarantee that surface creation or even instance creation is possible.</para>
        /// <para>For example, on Fermi systems Nvidia will install an ICD that provides no</para>
        /// <para>actual Vulkan support.  Call</para>
        /// <para>whether the extensions necessary for Vulkan surface creation are available</para>
        /// <para>and</para>
        /// <para>family of a physical device supports image presentation.</para>
        /// <para>Added in version 3.2.</para>
        /// </remarks>
        ...
        /// <para>to check whether Vulkan is at least minimally available.</para>
        ...
        /// <para>This function currently only supports the</para>
        /// <para>`VK_MVK_macos_surface` extension from MoltenVK.</para>
        /// <para>The returned array is allocated and freed by GLFW.  You</para>
        /// <para>should not free it yourself.  It is guaranteed to be valid only until the</para>
